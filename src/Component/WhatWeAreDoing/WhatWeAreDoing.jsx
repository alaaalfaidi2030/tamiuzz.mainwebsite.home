            ...
            >
                <div className="row">
                    ...
                    <div className="col-md-6 ">
                        <p>{t("homePage.what are we doing?_desc")}</p>
                    </div>
                ...
                <div className={"row g-3 " + style.info} >
                    ...
                    </div>
                    {
                        phoneAndEmail.map((item, idx) =>
                            <div className="col-md-3 col-sm-6  border-end border-3 border-white d-flex  align-items-center gap-3">
